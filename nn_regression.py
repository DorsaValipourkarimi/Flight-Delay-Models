...
# Turn late_aircraft_delay into 5 classes
...
# Build NN model
# -----------------------------
def build_model(input_dim, num_classes, neurons=128, hidden_layers=4,
...
# -----------------------------
print("\n=== Dev Set Performance ===")
dev_pred_probs = model.predict(X_dev)
dev_pred = np.argmax(dev_pred_probs, axis=1)
